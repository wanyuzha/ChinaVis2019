    ...
    <div>
        <Tabs value="norm" style="width:400px;">
            <TabPane label="普通会务" name="norm">
                <Table :columns="columns2" :data="tableData2" width="370" height="400"></Table>
            </TabPane>
            <TabPane label="安保人员" name="sec">
                <Table :columns="columns1" :data="tableData1" width="370" height="400"></Table>
            </TabPane>
...
export default {
    ...
    created () {
        ...
        this.$bus.$on('timechange',({time,day}) => {
            ...
            that.$axios.get('http://localhost:5270/worker',{
                params:{
                    time:time,
                    day:day
                }
