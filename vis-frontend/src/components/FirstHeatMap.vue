<template>
  <div>
    <div id="first-heatmap" style="width: 1000px;height:600px;"></div>
  </div>
</template>
<script>
...
export default {
  name: 'firstHeatMap',
  mounted() {
    const myChart = echarts.init(document.getElementById('first-heatmap'));
    let time = [];
    ...
    echarts.registerMap('first-floor', geoJson);
    const option = {
      baseOption: {
        timeline: {
          axisType: 'category',
